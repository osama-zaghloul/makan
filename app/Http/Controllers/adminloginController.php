...
class adminloginController extends Controller
{
    ...
    public function index()
    {
        if(Auth::guard('admin')->check()) 
        {
            ...
            return view('admin.dashboard',compact('mainactive','subactive','logo','allmembers','allitems','allcategories','itemorders','allmessages','alltransfers'));
        }
        else
        {
            $logo = setting::value('logo');
    ...
    public function store(Request $request)
    {
        ...
        $pass     = $request['pass'];
        // $admin = admin::where('username',$username)->where('password',$pass )->first();
        // if($admin)
        // {
