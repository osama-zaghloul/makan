      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="ادخل الاسم الأول " value="{{$eduser->name}}" required>
                    @if ($errors->has('name'))
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="lastname" placeholder="ادخل الاسم الأخير " value="{{$eduser->lastname}}" required>
                ...
                <div class="form-group col-md-6">
                    <label>الإيميل </label>
                    <input type="text" class="form-control" name="email" placeholder="ادخل  الإيميل" value="{{ $eduser->email }}" required>
                    @if ($errors->has('email'))
