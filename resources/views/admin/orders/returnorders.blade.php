...
@section('title') لوحة التحكم |  الطلبات المرتجعة @endsection
@section('content')
       ...
       <div class="col-md-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li style="margin-right: 0px; width:100%;" class="active text-center"><a href="#activity" data-toggle="tab">الطلبات المرتجعة </a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="active tab-pane" id="activity">
                        <div class="box">  
                            ...
                            <h3 class="box-title">الطلبات المرتجعة</h3>
                                            ...
                                            {{-- @if($dayorders == $nowday && $weekorders == $nowweek && $monthorders == $nowmonth && $yearorders == $nowyear) --}}
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;"> 
                                                        ...
                                                        @elseif($order->back == 2) 
                                                             <span style="border-radius: 3px;border: 1px solid green;color: springgreen;float:left;padding: 3px;font-weight: bold;background: #fff;display: inline-block;margin-top: 4%;" class="ads__item__featured">جارى إرجاع الطلب</span>
                                                    ...
                                                    <td style="text-align:center;">
                                                        @if($order->back == 1) 
                                                            {{ Form::open(array('method' => 'patch',"onclick"=>"return confirm('هل انت متاكد ؟!')",'files' => true,'url' =>'adminpanel/orders/'.$order->id )) }}
                                                                    <input type="hidden" name="raccept" >
                                                        ...
                                                        @elseif($order->back == 2) 
                                                            {{ Form::open(array('method' => 'patch',"onclick"=>"return confirm('هل انت متاكد ؟!')",'files' => true,'url' =>'adminpanel/orders/'.$order->id )) }}
                                                                    <input type="hidden" name="rfinish" >
