...
@section('title') لوحة التحكم | الأقسام الفرعية  @endsection
@section('content')
        ...
        <div class="col-xs-12">
            <div class="box box-primary">   
                <div class="box-header with-border">
                    <h3 class="box-title">كل الأقسام الفرعية </h3>
                    <button style="float:left" type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-addclass"><i class="fa fa-plus" aria-hidden="true"></i> إضافة قسم فرعي جديد</button>
                </div>  
                ...
                <div class="modal fade" id="modal-addclass" style="display: none;">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            {{ Form::open(array('method' => 'POST','files'=>true,'url' => 'adminpanel/subcategories')) }}
                                 ...
                                 <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <select name="maincategory" id="" required>
                                            ...
                                            <option value="{{$mcategory->id}}">{{$mcategory->arcategory}}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('maincategory'))
                                        <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('maincategory') }}</div>
                                        @endif
                                    </div>  
                                </div> 
                ...
                <div class="active tab-pane" id="activity">
                    <div class="table-responsive box-body">
                        ...
                        <table id="example3" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th style="text-align:center;"> القسم الفرعي</th>
                                        <th style="text-align:center;">القسم الرئيسي</th>
                                ...
                                <tbody> 
                                    ...
                                    <?php 
                                        $maincategory  = DB::table('categories')->where('id',$category->category_id)->first();
                                    ?>
                                        <tr>
                                            
                                            <td>{{$category->artitle}}</td>
                                            <td>{{$maincategory->arcategory}}</td>
                                            ...
                                            <td>
                                                {{ Form::open(array('method' => 'DELETE',"onclick"=>"return confirm('هل انت متأكد ؟!')",'files' => true,'url' => array('adminpanel/subcategories/'.$category->id))) }}
                                    ...
                                    <div class="modal fade" id="modal-upclass{{$category->id}}" style="display: none;">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                {{ Form::open(array('method' => 'patch','files'=>true,'url' => 'adminpanel/subcategories/'.$category->id )) }}
                                                    
                                                    <div class="form-group col-md-12">
                                                        <label>اسم القسم باللغة العربية</label>
                                                        <div class="form-group col-md-12">
                                                            <input style="width:100%;" type="text" class="form-control" name="arcategory" placeholder="اسم القسم باللغة العربية" value="{{$category->artitle}}" required>
                                                            @if ($errors->has('arcategory'))
                                                            <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('arcategory') }}</div>
                                                            @endif
                                                        </div>  
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label>اسم القسم باللغة الانجليزية</label>
                                                        <div class="form-group col-md-12">
                                                            <input style="width:100%;" type="text" class="form-control" name="encategory" placeholder="اسم القسم باللغة الانجليزية" value="{{$category->entitle}}" required>
                                                            @if ($errors->has('encategory'))
                                                            <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('encategory') }}</div>
                                                            @endif
                                                        </div>  
                                    ...
                                    <div class="form-group col-md-12">
                                        <select name="maincategory" id="" required>
                                            @foreach($categories as $mcategory)
                                            <option @if($mcategory->id == $category->category_id)  selected @endif value="{{$mcategory->id}}">{{$mcategory->arcategory}} </option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('maincategory'))
                                        <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('maincategory') }}</div>
