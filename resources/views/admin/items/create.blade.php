                 ...
                 <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control"  name="subcategory_id" required>
                            <option value="0" disabled="" selected="">اختار القسم الفرعي</option>
                            @foreach($allsubcats as $cat)
                                <option value="{{$cat->id}}"> {{$cat->artitle}} </option>
                            @endforeach
                        </select>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="number" name="count" class="form-control" placeholder = 'ادخل عدد المتوفر من المنتج' required>
                    @if ($errors->has('count'))
