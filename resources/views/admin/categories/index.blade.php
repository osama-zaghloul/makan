        ...
        <div class="col-xs-12">
            <div class="box box-primary">   
                <div class="box-header with-border">
                    <h3 class="box-title">كل الاقسام </h3>
                                ...
                                <tbody> 
                                    @foreach($allcategories as $category)
                                        <tr>
                                            ...
                                            <td><img style="width:100px;height:100px;" src="{{asset('users/images/'.$category->image)}}" alt="{{$category->arcategory}}"></td>
                                            <td>{{$category->arcategory}}</td>
