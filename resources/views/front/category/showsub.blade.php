 ...
 <div class="title_page">
        <div class="container">
            <ul>
                ...
                <li>
                   <a href="{{asset('/categories/'.$showcategory->id)}}"> 
                    @if(session('locale')=='ar') {{$showcategory->arcategory}}@else {{$showcategory->encategory}}@endif / </a>

                    @if($subcategory)

                        @if(session('locale')=='ar') {{$subcategory->artitle}}@else {{$subcategory->entitle}}@endif
                    @endif
                </li>
            </ul>
        </div>
...
@if(count($subcategoryitems)!=0)
    ...
    <div class="tt-filters-options">
        <div class="container">
            ...
            <h1 class="tt-title">
            @if(session('locale')=='ar') {{$subcategory->artitle}}@else {{$subcategory->entitle}}@endif <span class="tt-title-total listing-total-js">({{$itemscount}})</span>
            </h1>
